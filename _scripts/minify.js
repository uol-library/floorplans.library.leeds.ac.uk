...
fs.writeFileSync( path.resolve( __dirname, jsdir, 'modules/config.mjs' ), UglifyJS.minify({
     "export.js": fs.readFileSync( path.resolve( __dirname, jsdir, 'config/export.js' ), "utf8" ),
     "features.js": fs.readFileSync( path.resolve( __dirname, jsdir, 'config/features.js' ), "utf8" ),
     "imageLayers.js": fs.readFileSync( path.resolve( __dirname, jsdir, 'config/imageLayers.js' ), "utf8" ),
     "icons.js": fs.readFileSync( path.resolve( __dirname, jsdir, 'config/icons.js' ), "utf8" )
}, { toplevel: true } ).code, "utf8" );
